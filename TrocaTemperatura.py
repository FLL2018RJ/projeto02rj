...
class TrocaTemperatura(object):
    
    def __init__(self):
        print("TrocaTemperatura.PY")
        
    def troca(self, testeSensorPeso):
        print("Dentro do metodo limpa da classe TrocaTemperatura.PY")
        ...
        ####NEWS: Poço no mínimo 9
        if ultra.leituraPoco() >= 8:
            print("Entrou na troca. leitura do poco: ", ultra.leituraPoco())
            aviso = "Troca Iniciada. "
            ...
            while (ultra.leituraBebedouro() < 9):
                print("leitura do bebedouro em troca por temperatura. Deve parar quando >=9", ultra.leituraBebedouro())
            ...
            #Poço ficou seco durante enchimento. Consumode de água ZERO. Registrar Dados e mandar email
                ...
                bomba.desligaBombaPoco()
                aviso = "Troca interrompida. Poço vazio. "
                estacaoAgora = Estacao('', temp.tempBebedouro(),temp.tempPoco(),ultra.leituraBebedouro(), ultra.leituraPoco(),peso.pesa(),datetime.datetime.now(), 'Fechada', 'Desligada', aviso, 0,'')
                estacao = sistemaLib.retornaUltimoRegistro()
        ...
        #
            ...
            aviso = "Troca não inicializada. Poço Vazio. "
            statusValvula = "Fechada"
